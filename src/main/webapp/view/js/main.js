...
// }
const mainSlide = document.querySelector(".slideBox");
const goverSlide = document.querySelector(".slideBox_gover");
const toLeft = document.querySelector(".toLeft");
const toRight = document.querySelector(".toRight");
let disable = true;
let loopDisable = true;

const toRightFunc = (mainSlide) => {
...
setInterval(() => {
    if(loopDisable) {
      toRightFunc(mainSlide);
      toRightFunc(goverSlide);
    }
  }, 5000);
